            ...
            <div class="collapse navbar-collapse justify-content-around" id="navbarsExample02">
                ...
                <?php if (!Yii::app()->user->isGuest) { ?>
                    <div>
                        ...
                        <div class="row m-0 mr-5 w-100 p-0 position-absolute">
                            <ul class="h-auto m-0 p-0 w-100 " id="list"></ul>
                        </div>
                    </div>
        ...
        const filter = () => {
            ...
            for (let icon of icons) {
                ...
                if (name.indexOf(text) !== -1) {
                    list.innerHTML += `	<div class="d-flex   mx-1 my-1">
														<li id="input_list" class="text-decoration-none w-100 px-3 bg-info  py-2 d-block">
